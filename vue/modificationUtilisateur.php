...
$utilisateur = $RepositoryUtilisateur->detailUtilisateur($_GET["id"]);
...
<div class="container mt-4">
    ...
    <form action="../src/traitement/utilisateur/traitementModificationUtilisateur.php" method="post">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="mdp" name="mdp" value="<?=$utilisateur->getMdp()?>">
        </div>
