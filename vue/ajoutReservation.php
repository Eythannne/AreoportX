...
$reservation = new RepositoryReservation();
...
<div class="container">
    <h2 class="mb-3">Ajout Reservation</h2>
    <form method="POST" action="../src/traitement/reservation/traitementAjoutReservation.php">
        <div class="mb-3">
            <label for="nb_place_reserver" class="form-label">Nombre place reserver</label>
            <input type="text" class="form-control" id="nb_place_reserver" name="nb_place_reserver" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <select class="form-control" id="ref_utilisateur" name="ref_utilisateur">
                <?php foreach ($utilisateur as $utilisateur) {
                    echo "<option value='" . $utilisateur["id_utilisateur"] . "'>" . $utilisateur["nom"] . "   " . $utilisateur["prenom"] . "</option>";
                } ?>
            </select>
        </div>
