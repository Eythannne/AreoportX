...
$listeUtilisateur = (new RepositoryUtilisateur())->listeUtilisateur();
?>
...
<div class="container">
    ...
    <input type="text" id="search" class="search-bar" onkeyup="filterUtilisateur()" placeholder="Rechercher un utilisateur...">

    <div class="mb-3">
        <a href="ajoutUtilisateur.php" class="btn btn-primary w-100">Ajouter un utilisateur</a>
    </div>
    <table>
        <thead>
        <tr>
            ...
            <tr>
                ...
                <td>
                    <div class="d-grid gap-2">
                        <a href="modificationUtilisateur.php?id=<?= $utilisateur['id_utilisateur'] ?>" class="btn btn-warning btn-sm w-100">Modifier</a>
                        <a href="../src/traitement/utilisateur/traitementSuppressionUtilisateur.php?id=<?= $utilisateur['id_utilisateur'] ?>" class="btn btn-danger btn-sm w-100" onclick="return confirm('Es-tu sûr de vouloir supprimer cet utilisateur ?')">Supprimer</a>
                    </div>
                </td>
            </tr>
        <?php endforeach; ?>
